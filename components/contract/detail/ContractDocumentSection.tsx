...
export default function ContractDocumentSection({
  ...
  const [previewDoc, setPreviewDoc] = useState<ContractDocumentResponse | null>(null);
                    ...
                    <>
                      {(doc.viewUrl || doc.downloadUrl) && (
                        <button
                          ...
                          className="h-8 px-3 rounded-lg border border-border bg-card hover:bg-muted hover:border-primary/40 text-foreground text-xs font-semibold inline-flex items-center gap-1.5 shadow-2xs transition-colors cursor-pointer"
                        >
                      ...
                      {doc.downloadUrl && (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="h-8 px-3 rounded-lg bg-primary hover:bg-primary/90 text-primary-foreground text-xs font-bold inline-flex items-center gap-1.5 shadow-2xs transition-colors"
                        >
